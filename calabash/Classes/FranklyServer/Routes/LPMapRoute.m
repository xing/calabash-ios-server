...
- (id) handleRequestForPath:(NSArray *) path withConnection:(id) connection {
  LPLogInfo(@"DEBUG: %@:%@ %@", self, NSStringFromSelector(_cmd), path);
...
- (NSArray *) applyOperation:(NSDictionary *) operation
  ...
  LPLogInfo(@"DEBUG: %@:%@ %@", self, NSStringFromSelector(_cmd), views);
...
- (NSDictionary *) JSONResponseForMethod:(NSString *) method
  ...
  LPLogInfo(@"DEBUG: %@:%@ %@ %@: %@", self, NSStringFromSelector(_cmd), method, path, data);
